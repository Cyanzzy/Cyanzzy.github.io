...
首先，需要定义两个Caffeine的缓存对象，分别保存商品、库存的缓存数据。
...
![yeVDlwtfMx](E:/work/job/尚硅谷资源/Redis-笔记资料/03-高级篇/讲义/02-多级缓存/assets/yeVDlwtfMx.png)
...
请求地址是localhost，端口是80，就被windows上安装的Nginx服务给接收到。然后代理给了OpenResty集群：
